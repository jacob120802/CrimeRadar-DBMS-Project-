...
if(isset($_POST['submit']))
{
	...
	if(isset($_SESSION['login_id']))
	{
		...
		$sql = $sql . ",cop_pofile='$_POST[cop_pofile]',gender='$_POST[gender]',contact_no='$_POST[contact_no]',email_id='$_POST[email_id]' WHERE login_id='$_SESSION[login_id]'";
	...
	{
		$sql ="INSERT INTO cop (cop_name,substation_id,designation_id,img,cop_pofile,gender,contact_no,email_id)values('$_POST[cop_name]','$_POST[substation_id]','$_POST[designation_id]','$filename','$_POST[cop_pofile]','$_POST[gender]','$_POST[contact_no]','$_POST[email_id]')";
		$qsql = mysqli_query($con,$sql);
			echo mysqli_error($con);
		if(mysqli_affected_rows($con) == 1)
		{
...
if(isset($_SESSION['login_id']))
{
	$sqledit = "SELECT * FROM cop WHERE login_id='$_SESSION[login_id]'";
...
<html lang="en">
  ...
  <header>
        ...
        <section class="breadcrumb-section parallax" style="background-image: url(67.png); background-repeat: no-repeat;
  background-size: 1250px 175px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-title">
                            <h1 style="color:maroon; text-align: left;">COP PROFILE </h1>
                        </div>
                    </div>
                </div>
            </div>
