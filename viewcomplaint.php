...
<table id="datatablefixcolumn"  class="table table-striped table-bordered">
	...
	<tbody>
		...
		while($rs = mysqli_fetch_assoc($qsql))
		{
			...
			echo "<a href='complaintacknowledgementreport.php? goid=$rs[complaint_id]' class='btn btn-info' style='width: 70px;'>View</a>";
			echo "</td></tr>";
		}
	?>
	</tbody>
