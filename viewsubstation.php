...
if(isset($_GET['delid']))
{
	$sql = "DELETE FROM substation WHERE substation_id='$_GET[delid]'";
	$qsql = mysqli_query($con,$sql);
		echo mysqli_error($con);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Sub-Station record deleted successfully...');</script>";
...
<h3 class="underline"><span>View Sub-Stations<br><a href='addsubstation.php' class='btn btn-danger' style='width: 240px;'>Add a New Sub-Station?</a><br></span></h3>
...
<table id="datatable"  class="table table-striped table-bordered">
	...
	<tbody>
		...
		while($rs = mysqli_fetch_array($qsql))
		{
			...
			<a href='addsubstation.php?editid=$rs[substation_id]' class='btn btn-warning'>Edit</a>
            <a href='viewsubstation.php?delid=$rs[substation_id]'onclick='return confirmdel()' class='btn btn-danger'>Delete</a>
