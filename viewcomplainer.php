...
<html lang="en">
  <head>
    ...
    <title>COMPLAINER DETAILS</title>
  ...
  <header>
        <nav class="navbar navbar-expand-lg ">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="viewcomplainer.php">View Complainer</a></li>
          </ul>
        </li>
...
<h3 class="underline"><span>View Complainers</span></h3>
...
<table id="datatable"  class="table table-striped table-bordered">
	<thead>
		<tr>		
			...
			<th style='width: 170px;'><h5>Complaints</h5></th>
		</tr>
	</thead>
	<tbody>
		<?php
		...
		while($rs = mysqli_fetch_array($qsql))
		{
			echo "<tr>					
						...
						<td>$rs[mobile]</td>				
						<td>
			<a href='viewcomplaint.php?complainerid=$rs[complainer_id]' class='btn btn-primary'>View</a>
